...
class FedArguments:
    ...
    fed_normbounding: Optional[int] = field(default=5, metadata={"help": "The bounding scaling for norm_bounding: Ref to Alibaba-FederatedScope- L2 = 5"})
    #fednova_ratio: Optional[float] = field(default=1.0, metadata={"help": "relative sample size of client for FedNova"}) # Modify For FedNova
    #fednova_gmf: Optional[float] = field(default=0.0, metadata={"help": "global momentum factor for FedNova"})
...
class ScriptArguments:
    ...
    inference_sample: Optional[int] = field(default=100, metadata={"help": "the number of inference sample to use from the dataset"})
    local_data_dir: Optional[str] = field(default=None, metadata={"help": "the local data directory if you want to use downloaded data"})
    topk : Optional[int] = field(default=1, metadata={"help": "K-number for sparsification"})
    spa_bin : Optional[int] = field(default=4, metadata={"help": "binning option for FUSE-SPA"})
    rdx_scale : Optional[int] = field(default=10^5, metadata={"help": "fuse-rdx scaling"})
